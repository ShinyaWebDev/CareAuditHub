...
import type { AuthUser } from '../utils/token'
...
export async function createReport(input: CreateReportInput, actor: AuthUser) {
...
export async function validateReportById(id: string, actor: AuthUser) {
